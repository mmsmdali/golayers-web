/* @preserve
 * GoLayers 1.0.0+main.f277ebe, Google Maps JavaScript Web API Extensions/ Wrappers
 * for OGC (WMS, WFS, ...), ArcGIS (REST, OGC enabled, ...) & other Geospatial Map Services/ Layers/ Resources.
 * (c) 2021 - 2022 Mohamed Ali.
 */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.golayers = {}));
})(this, (function (exports) { 'use strict';

  var version = "1.0.0+main.f277ebe7";
  ...
  function TileWMS(url, options) {
  	...
  	var
  		...
  		getTileUrl = function (point, zoom) {
  			...
  			if (crs == Epsg.sphericalMercator.code || Util.contains(Epsg.sphericalMercator.aliases, crs)) ; else {
...
//# sourceMappingURL=golayers-src.js.map
